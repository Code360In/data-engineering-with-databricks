...
-- MAGIC %python
-- MAGIC spark.table("csv_orders").write.mode("append").format("csv").save(f"{Paths.source}/sales/sales.csv")
...
DROP TABLE IF EXISTS jdbc_users;
...
-- MAGIC %md Extract raw events from JSON files
